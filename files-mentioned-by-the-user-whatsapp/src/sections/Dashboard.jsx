        ...
        <div className="grid gap-5 lg:grid-cols-[17rem_1fr]">
          <aside className="glass top-28 h-max rounded-[2rem] p-4 lg:sticky">
            <div className="rounded-[1.5rem] bg-gradient-to-br from-ink-950 to-eco-700 p-5 text-white">
              ...
              <p className="mt-4 text-lg font-black">EcoCity Ops</p>
              <p className="mt-2 text-sm leading-6 text-white/62">AI recommendations active for 18 municipal wards.</p>
            </div>
          ...
          <div className="grid gap-5">
            <div className="grid gap-5 md:grid-cols-3">
              {[
                ['Pickup requests', '506', '+18%', Route],
                ['Sorted waste', '86%', '+9%', Activity],
                ['Risk alerts', '12', '-4%', Siren],
                ...
                <GlassCard key={label}>
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="mt-2 text-sm font-black text-eco-700 dark:text-eco-200">{change} this week</p>
                    </div>
                    <IconBadge icon={Icon} />
                  </div>
                </GlassCard>
