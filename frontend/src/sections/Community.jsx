    ...
    <section id="community" className="px-4 py-20">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-5 lg:grid-cols-[1fr_0.95fr]">
          <GlassCard>
            <div className="mb-6 flex items-center justify-between">
              <div>
                <p className="text-sm font-black uppercase tracking-[0.22em] text-eco-700 dark:text-eco-200">{t('community.rankings')}</p>
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-[1fr_0.9fr]">
              ...
              {challenges.map((challenge) => {
                ...
                return (
                  <div key={challenge.title} className="rounded-[1.5rem] bg-eco-50 p-5 dark:bg-white/8">
                    ...
                    <p className="mt-3 text-sm font-bold text-ink-800/55 dark:text-white/50">{challenge.participants.toLocaleString()} {t('community.participants')}</p>
          ...
          <GlassCard>
            <h3 className="mb-6 text-2xl font-black text-ink-950 dark:text-white">{t('community.notifications')}</h3>
            <div className="space-y-4">
